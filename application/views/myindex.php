...
<head>
  ...
  <link href="<?php echo base_url().'/assets/lightbox/css/lightbox.min.css'?>" rel="stylesheet">
...
<body>
  ...
  <script src="<?php echo base_url().'/assets/jquery/jquery-migrate.min.js'?>"></script>
  ...
  <script src="<?php echo base_url().'/assets/waypoints/waypoints.min.js'?>"></script>
  ...
  <script src="<?php echo base_url().'/assets/touchSwipe/jquery.touchSwipe.min.js'?>"></script>
